...
cp ./default/default-httpd-eap73-template.yaml ${newPrjName}-${newAppName}-eap73-template.yaml
cp ./default/default-httpd-eap73-volume.yaml ${newPrjName}-${newAppName}-eap73-volume.yaml
